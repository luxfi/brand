/**
 * Theme management for Lux brand
 */
...
export const lightTheme: Theme = {
  name: 'light',
  colors: colors,
  cssVariables: getCSSVariables('lux'),
}
...
export function applyTheme(theme: keyof typeof themes | Theme = 'light') {
  ...
  // Store preference
  localStorage.setItem('lux-theme', themeConfig.name)
}
...
export function createTheme(config: Partial<Theme>): Theme {
  return {
    ...
    cssVariables: config.cssVariables || getCSSVariables('lux'),
  }
}
